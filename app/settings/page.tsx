    ...
    <div className="min-h-screen bg-[#0a0a0f] text-[#e8e8f0]">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12 space-y-6">
        ...
        <div className="bg-white/5 border border-white/8 rounded-2xl p-6 space-y-4">
          ...
          {plan === 'pro' && (
            <div className="pt-2 border-t border-white/8">
              <p className="text-sm text-gray-400 mb-3">ניהול מנוי, ביטול ועדכון כרטיס אשראי</p>
              <button
                disabled
                className="w-full border border-white/10 text-gray-500 py-2.5 rounded-xl text-sm cursor-not-allowed"
              >
                פורטל ניהול מנוי — בקרוב
              </button>
            </div>
          )}
        </div>
