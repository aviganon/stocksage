  ...
  return (
    <div className="min-h-screen text-[#e8e8f0]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 animate-fade-up">
        <h1 className="text-3xl font-bold text-gradient mb-2">תנאי שימוש</h1>
        <p className="text-gray-500 text-sm mb-10">עדכון אחרון: מאי 2026</p>

        <div className="glass rounded-3xl p-8 prose prose-invert max-w-none space-y-8 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              ניתוח מהיר זמין ללא תשלום לכל משתמש. ניתוח מלא ($1.99/דוח) וניתוח עמוק ($3.99/דוח)
              הם שירותים בתשלום. מנוי Pro מאפשר ניתוח מלא ועמוק ללא הגבלה. ביטול מנוי ניתן
              בכל עת ויכנס לתוקף בסוף תקופת החיוב. אין החזרים על דוחות שכבר עובדו.
            </p>
          </section>
