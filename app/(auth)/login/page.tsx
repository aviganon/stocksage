      ...
      <div className="w-full max-w-sm animate-fade-up">
        ...
        <div className="glass-card rounded-3xl p-8">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 btn-glow text-white py-4 rounded-2xl text-sm font-semibold disabled:opacity-50 transition-all"
          >
          ...
          {error && (
            <p className="mt-4 text-red-300 text-sm bg-red-500/10 border border-red-500/20 rounded-xl px-3 py-2 text-center">
              {error}
            </p>
          )}
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          {t('auth.noAccount')}{' '}
          <Link href="/signup" className="text-indigo-300 hover:text-indigo-200 font-medium transition-colors">
            {t('nav.getStarted')}
          </Link>
        </p>
      </div>
